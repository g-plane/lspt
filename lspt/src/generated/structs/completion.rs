...
pub type Params = raw::CompletionParams;

pub type List = raw::CompletionList;

pub type RegistrationOptions = raw::CompletionRegistrationOptions;

pub type Context = raw::CompletionContext;

pub type Options = raw::CompletionOptions;

pub type ServerItemOptions = raw::ServerCompletionItemOptions;

pub type ListCapabilities = raw::CompletionListCapabilities;

pub mod item {
    pub type Item = super::raw::CompletionItem;

    pub type LabelDetails = super::raw::CompletionItemLabelDetails;

    pub type Defaults = super::raw::CompletionItemDefaults;

    pub type ApplyKinds = super::raw::CompletionItemApplyKinds;

    pub type TagOptions = super::raw::CompletionItemTagOptions;
}

pub mod client {
    pub type Capabilities = super::raw::CompletionClientCapabilities;

    pub mod item {
        pub type Options = super::super::raw::ClientCompletionItemOptions;

        pub type OptionsKind = super::super::raw::ClientCompletionItemOptionsKind;

        pub type ResolveOptions = super::super::raw::ClientCompletionItemResolveOptions;

        pub type InsertTextModeOptions = super::super::raw::ClientCompletionItemInsertTextModeOptions;
    }
}